...
int main() {
  ...
  18:	75 4c                	jne    66 <main+0x66>
    set_priority(90); // prioritas rendah
  1a:	83 ec 0c             	sub    $0xc,%esp
  1d:	6a 5a                	push   $0x5a
  1f:	e8 ef 03 00 00       	call   413 <set_priority>
  for (volatile int i = 0; i < 100000000; i++);
  24:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  2b:	8b 45 f4             	mov    -0xc(%ebp),%eax
  2e:	83 c4 10             	add    $0x10,%esp
  31:	3d ff e0 f5 05       	cmp    $0x5f5e0ff,%eax
  36:	7f 1b                	jg     53 <main+0x53>
  ...
  4c:	3d ff e0 f5 05       	cmp    $0x5f5e0ff,%eax
  51:	7e ed                	jle    40 <main+0x40>
    busy();
    printf(1, "Child 1 selesai\n");
  53:	51                   	push   %ecx
  54:	51                   	push   %ecx
  55:	68 38 08 00 00       	push   $0x838
  5a:	6a 01                	push   $0x1
  5c:	e8 6f 04 00 00       	call   4d0 <printf>
    exit();
  61:	e8 0d 03 00 00       	call   373 <exit>
  }

  int pid2 = fork();
  66:	e8 00 03 00 00       	call   36b <fork>
  if (pid2 == 0) {
  6b:	85 c0                	test   %eax,%eax
  6d:	75 47                	jne    b6 <main+0xb6>
    set_priority(10); // prioritas tinggi
  6f:	83 ec 0c             	sub    $0xc,%esp
  72:	6a 0a                	push   $0xa
  74:	e8 9a 03 00 00       	call   413 <set_priority>
  for (volatile int i = 0; i < 100000000; i++);
  79:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  80:	8b 45 f4             	mov    -0xc(%ebp),%eax
  83:	83 c4 10             	add    $0x10,%esp
  86:	3d ff e0 f5 05       	cmp    $0x5f5e0ff,%eax
  8b:	7f 16                	jg     a3 <main+0xa3>
  8d:	8d 76 00             	lea    0x0(%esi),%esi
  90:	8b 45 f4             	mov    -0xc(%ebp),%eax
  93:	83 c0 01             	add    $0x1,%eax
  96:	89 45 f4             	mov    %eax,-0xc(%ebp)
  99:	8b 45 f4             	mov    -0xc(%ebp),%eax
  9c:	3d ff e0 f5 05       	cmp    $0x5f5e0ff,%eax
  a1:	7e ed                	jle    90 <main+0x90>
    busy();
    printf(1, "Child 2 selesai\n");
  a3:	52                   	push   %edx
  a4:	52                   	push   %edx
  a5:	68 49 08 00 00       	push   $0x849
  aa:	6a 01                	push   $0x1
  ac:	e8 1f 04 00 00       	call   4d0 <printf>
    exit();
  b1:	e8 bd 02 00 00       	call   373 <exit>
  }

  wait(); wait();
  b6:	e8 c0 02 00 00       	call   37b <wait>
  bb:	e8 bb 02 00 00       	call   37b <wait>
  printf(1, "Parent selesai\n");
  c0:	50                   	push   %eax
  c1:	50                   	push   %eax
  c2:	68 5a 08 00 00       	push   $0x85a
  c7:	6a 01                	push   $0x1
  c9:	e8 02 04 00 00       	call   4d0 <printf>
  exit();
  ce:	e8 a0 02 00 00       	call   373 <exit>
  d3:	66 90                	xchg   %ax,%ax
  d5:	66 90                	xchg   %ax,%ax
  d7:	66 90                	xchg   %ax,%ax
  d9:	66 90                	xchg   %ax,%ax
...
void busy() {
  ...
  f0:	3d ff e0 f5 05       	cmp    $0x5f5e0ff,%eax
  f5:	7f 1c                	jg     113 <busy+0x33>
  f7:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  fe:	66 90                	xchg   %ax,%ax
 100:	8b 45 fc             	mov    -0x4(%ebp),%eax
 103:	83 c0 01             	add    $0x1,%eax
 106:	89 45 fc             	mov    %eax,-0x4(%ebp)
 109:	8b 45 fc             	mov    -0x4(%ebp),%eax
 10c:	3d ff e0 f5 05       	cmp    $0x5f5e0ff,%eax
 111:	7e ed                	jle    100 <busy+0x20>
}
 113:	c9                   	leave  
 114:	c3                   	ret    
...
printf(int fd, const char *fmt, ...)
{
 ...
 654:	eb 1a                	jmp    670 <printf+0x1a0>
          s = "(null)";
 656:	bb 6a 08 00 00       	mov    $0x86a,%ebx
        while(*s != 0){
 ...
 6a1:	a1 38 0b 00 00       	mov    0xb38,%eax
{
 ...
 6e1:	5b                   	pop    %ebx
  freep = p;
 6e2:	89 15 38 0b 00 00    	mov    %edx,0xb38
}
 6e8:	5e                   	pop    %esi
 6e9:	5f                   	pop    %edi
 6ea:	5d                   	pop    %ebp
 ...
 719:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 71c:	89 15 38 0b 00 00    	mov    %edx,0xb38
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 739:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 73c:	8b 3d 38 0b 00 00    	mov    0xb38,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 787:	73 4f                	jae    7d8 <malloc+0xa8>
    ...
    if(p == freep)
 789:	8b 3d 38 0b 00 00    	mov    0xb38,%edi
 ...
 7b2:	e8 e9 fe ff ff       	call   6a0 <free>
  return freep;
 7b7:	a1 38 0b 00 00       	mov    0xb38,%eax
 ...
 7e4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 7e7:	a3 38 0b 00 00       	mov    %eax,0xb38
}
 ...
 807:	0b 00 00 
    base.s.size = 0;
 80a:	bf 3c 0b 00 00       	mov    $0xb3c,%edi
    base.s.ptr = freep = prevp = &base;
 80f:	c7 05 3c 0b 00 00 3c 	movl   $0xb3c,0xb3c
 816:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 819:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 81b:	c7 05 40 0b 00 00 00 	movl   $0x0,0xb40
 822:	00 00 00 
    if(p->s.size >= nunits){
