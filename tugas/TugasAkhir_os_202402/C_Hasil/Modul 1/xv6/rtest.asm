...
int main() {
  ...
  11:	e8 35 03 00 00       	call   34b <getreadcount>
  ...
  29:	8d 45 ee             	lea    -0x12(%ebp),%eax
  2c:	6a 05                	push   $0x5
  2e:	50                   	push   %eax
  2f:	6a 00                	push   $0x0
  31:	e8 85 02 00 00       	call   2bb <read>
  printf(1, "Read Count Setelah: %d\n", getreadcount());
  36:	e8 10 03 00 00       	call   34b <getreadcount>
  3b:	83 c4 0c             	add    $0xc,%esp
  3e:	50                   	push   %eax
  3f:	68 90 07 00 00       	push   $0x790
  44:	6a 01                	push   $0x1
 ...
 5e1:	a1 54 0a 00 00       	mov    0xa54,%eax
{
 ...
 621:	5b                   	pop    %ebx
  freep = p;
 622:	89 15 54 0a 00 00    	mov    %edx,0xa54
}
 628:	5e                   	pop    %esi
 629:	5f                   	pop    %edi
 62a:	5d                   	pop    %ebp
 ...
 659:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 65c:	89 15 54 0a 00 00    	mov    %edx,0xa54
    p->s.size += bp->s.size;
